...
_MM_    \M\_dM_     _dMM_MM_    _MM_dM_     _dMM_M_      _MM_
 ...
 \033[1;37m Owner   : 🇵🇰🇵🇰👌کوس کی لاڔ شی😜
 \033[1;37m Facebook: 🇵🇰🇵🇰👌بوک شه😂
 \033[1;37m Github  :🇦🇫🇦🇫💪 ستاسی پلار👌
 \033[1;37m Version :✌2004💪+4591937471👈
 \033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/FuhqoXGjsz9Cx7ELuJRqdC')
        pass
    elif select =='F':
